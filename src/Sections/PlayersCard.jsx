...
const PlayersCard = ({player, setAvailableBalance, availableBalance}) => {

    const [isSelected, setIsSelected] = useState(false);

    const handleClicks = (playerData) => {

        const restOfCoin = parseInt(playerData.price.split("USD").join("").split(",").join("")); 

        if (availableBalance < restOfCoin) {
            alert("You don't have enough Coins!!");
            return
        }

        setIsSelected(true);
        setAvailableBalance(availableBalance - restOfCoin);
        ...
        <div key={player.id} className="card bg-base-100 shadow-md p-5">
            ...
            <div className="mt-5">
                ...
                <div className='flex justify-between items-center mt-3 mb-2'>
                    ...
                    <button className='bg-[#cbc5c550] font-medium text-black rounded-xl px-9 py-1'>
                        {player.role}
                    </button>
                ...
                <div className='flex justify-between items-center'>
                    ...
                    className="btn btn-primary rounded-xl bg-[#13131310] text-black shadow-none border-none">
